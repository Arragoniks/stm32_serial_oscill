...
#define LED_BLINK_FAST	LED_ON; HAL_Delay(50); LED_OFF

// 48 000 000
// 48 MHz clock -> ? Hz Timer
#define TIM_PRESC		1-1			// Prescaller
#define TIM_PRD			4800-1		// Period
...
/* USER CODE BEGIN PV */
Byte readyPart1 = FALSE;
Byte readyPart2 = FALSE;
